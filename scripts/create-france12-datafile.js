...
const OUTPUT_FILE = "./test-data/France12.json";
const LOCATION = "Paris, France"; // Major French city
const COORDINATES = [48.8566, 2.3522]; // Paris coordinates
const TIMEZONE = "Europe/Paris";

/**
 * Create France12 test file using adhan-js custom method calculations
 */
function createFrance12TestFile() {
  console.log(
    "🇫🇷 Creating France12 (UOIF 12°) 2025 test file from adhan-js custom method...\n"
  );
  ...
  for (let day = 1; day <= 30; day++) {
    ...
    // Create custom France12 method (12° fajr, 12° isha, 1 min maghrib adjustment)
    const france12Method = CalculationMethod.Other();
    france12Method.fajrAngle = 12;
    france12Method.ishaAngle = 12;
    france12Method.adjustments.maghrib = 1;

    const prayerTimes = new PrayerTimes(coordinates, date, france12Method);
  ...
  const output = {
    metadata: {
      source: "France12 Method Reference Implementation",
      ...
      notes:
        "Generated using adhan-js UOIF method (12°/12°/+1min maghrib) for validation purposes",
    },
    testCases,
  };
  ...
  console.log(`🎯 Method: France12 (UOIF 12°/12°)`);
