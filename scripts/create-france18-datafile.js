...
const OUTPUT_FILE = "./test-data/France18.json";
const LOCATION = "Paris, France"; // Major French city
const COORDINATES = [48.8566, 2.3522]; // Paris coordinates
const TIMEZONE = "Europe/Paris";

/**
 * Create France18 test file using adhan-js custom method calculations
 */
function createFrance18TestFile() {
  console.log(
    "🇫🇷 Creating France18 (UOIF 18°) 2025 test file from adhan-js custom method...\n"
  );
  ...
  for (let day = 1; day <= 30; day++) {
    ...
    // Create custom France18 method (18° fajr, 18° isha, 1 min maghrib adjustment)
    const france18Method = CalculationMethod.Other();
    france18Method.fajrAngle = 18;
    france18Method.ishaAngle = 18;
    france18Method.adjustments.maghrib = 1;

    const prayerTimes = new PrayerTimes(coordinates, date, france18Method);
  ...
  const output = {
    metadata: {
      source: "France18 Method Reference Implementation",
      ...
      notes:
        "Generated using adhan-js UOIF method (18°/18°/+1min maghrib) for validation purposes",
    },
    testCases,
  };
  ...
  console.log(`🎯 Method: France18 (UOIF 18°/18°)`);
